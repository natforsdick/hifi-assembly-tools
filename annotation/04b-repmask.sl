...
REF=asm3-hic-hifiasm-p-p_ctg-purged_rep1_scaffolds_final.contam-excl.simple.masked.fasta
...
date
RepeatMasker -pa 16 -a -e ncbi -dir ${OUTDIR}02_aves_out/ -nolow \
-species aves ${OUTDIR}01_simple_out/${REF} 2>&1 | tee ${OUTDIR}logs/01_avesmask.log
date
ml purge
