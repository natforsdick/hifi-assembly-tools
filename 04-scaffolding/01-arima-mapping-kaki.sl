...
#SBATCH --job-name=arima_map_kaki-asm5 # job name (shows up in the queue)
...
REF='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/01-purge-dups/01-primary.genome.scf-purged.fa' #'/path/to/reference_sequences/reference_sequeneces.fa'
FAIDX='$REF.fai'
PREFIX='01-primary.genome.scf-purged.fa' #'bwa_index_name'
RAW_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/SALSA/01_kaki_mapped' #'/path/to/write/out/bams'
FILT_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/SALSA/02_kaki_filtered' #'/path/to/write/out/filtered/bams'
...
PAIR_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/SALSA/03_kaki_paired' #'/path/to/write/out/paired/bams'
REP_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/SALSA/04_kaki_dedup' #'/path/to/where/you/want/deduplicated/files'
REP_LABEL=$LABEL\_rep1
MERGE_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/SALSA/05_kaki_merged' #'/path/to/final/merged/alignments/from/any/biological/replicates'
MAPQ_FILTER=10
CPU=12
