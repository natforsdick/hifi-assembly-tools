...
#SBATCH --mem=40GB
#SBATCH --time=00:50:00 #Walltime (HH:MM:SS)
...
date
bamToBed -i ${REP_DIR}${LABEL}\_rep1.bam > ${OUT_DIR}${LABEL}\_rep1.bed
echo “converted”
date
echo “Sorting ${LABEL}\_rep1.bed”
sort -k 4 ${OUT_DIR}${LABEL}\_rep1.bed > /nesi/nobackup/ga03186/tmp-${SLURM_JOB_ID}/tmp_bed${LABEL} && cp /nesi/nobackup/ga03186/tmp-${SLURM_JOB_ID}/tmp_bed${LABEL} ${OUT_DIR}${LABEL}\_rep1-sorted.bed
echo “sorted”
date
