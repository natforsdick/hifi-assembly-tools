...
#SBATCH --job-name=01-arima-indexing-asm5 # job name (shows up in the queue)
...
# PARAMS
############
HIC='Kaki_HiC_raw_all_R' #'basename_of_fastq_files'
LABEL='Kaki-HiC-mapped' #'overall_exp_name'
...
REF='/nesi/nobackup/ga03186/kaki-hifi-asm/asm5-masurca/01-purge-dups/01-primary.genome.scf-purged.fa' #'/path/to/reference_sequences/reference_sequences.fa'
FAIDX='$REF.fai'
PREFIX='01-primary.genome.scf-purged' #'bwa_index_name'
