...
#SBATCH --job-name=arima-kaki-asm3-pur # job name (shows up in the queue)
#SBATCH --cpus-per-task=18 # mapping can use 18, subsequent processing requires 6
#SBATCH --mem=15G
#SBATCH --time=20:00:00 #Walltime (HH:MM:SS) # Total processing minimum 12 hrs
...
SRA='Kaki_HiC_raw_all_R' #'basename_of_fastq_files'
LABEL='Kaki_HiCmapped' #'overall_exp_name'
...
REF='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/02-purge-dups/01P-asm3-hic-hifiasm-p-p_ctg-purged.fa' #'/path/to/reference_sequences/reference_sequeneces.fa'
FAIDX='$REF.fai'
PREFIX='01P-asm3-hic-hifiasm-p-p_ctg-purged.fa' #'bwa_index_name'
RAW_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/05-SALSA/pur/01_kaki_mapped' #'/path/to/write/out/bams'
FILT_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/05-SALSA/pur/02_kaki_filtered' #'/path/to/write/out/filtered/bams'
...
PAIR_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/05-SALSA/pur/03_kaki_paired' #'/path/to/write/out/paired/bams'
REP_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/05-SALSA/pur/04_kaki_dedup' #'/path/to/where/you/want/deduplicated/files'
REP_LABEL=$LABEL\_rep1
MERGE_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/05-SALSA/pur/05_kaki_merged' #'/path/to/final/merged/alignments/from/any/biological/replicates'
MAPQ_FILTER=10
CPU=12
...
cd /nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/02-purge-dups/
...
java -Xmx15G -Djava.io.tmpdir=${TMP_DIR} -jar $PICARD AddOrReplaceReadGroups INPUT=${TMP_DIR}/${SRA}.bam OUTPUT=${PAIR_DIR}/${SRA}.bam ID=$SRA LB=$SRA SM=$LABEL PL=ILLUMINA PU=none
...
java -Xmx15G -XX:-UseGCOverheadLimit -Djava.io.tmpdir=${TMP_DIR} -jar $PICARD MarkDuplicates INPUT=${PAIR_DIR}/${SRA}.bam OUTPUT=${REP_DIR}/${REP_LABEL}.bam METRICS_FILE=${REP_DIR}/metrics.${REP_LABEL}.txt TMP_DIR=${TMP_DIR} ASSUME_SORTED=TRUE VALIDATION_STRINGENCY=LENIENT REMOVE_DUPLICATES=TRUE
...
java -Xmx15G -XX:-UseGCOverheadLimit -Djava.io.tmpdir=${TMP_DIR} -jar $PICARD CollectAlignmentSummaryMetrics R=$REF I=${REP_DIR}/${REP_LABEL}.bam O=${REP_DIR}/${REP_LABEL}-summarystats.txt
