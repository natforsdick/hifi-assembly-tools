...
IN_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/SALSA/04_kaki_dedup/'
IN_BAM='Kaki_HiCmapped_rep1-sorted.bed'
OUT_DIR='/nesi/nobackup/ga03186/kaki-hifi-asm/asm3-hic-hifiasm-p/SALSA/05_kaki_SalsaScaff/'
...
$YAHS ${REF_DIR}${REF} ${IN_DIR}${IN_BAM} -o yahs-asm3
